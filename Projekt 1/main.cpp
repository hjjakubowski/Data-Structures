...
int main() {
    string datasets1[] = {
        "dataset_1000.txt", "dataset_5000.txt", "dataset_10000.txt", "dataset_100000.txt",
        "dataset_250000.txt", "dataset_500000.txt", "dataset_1000000.txt", "dataset_2500000.txt",
        "dataset_5000000.txt", "dataset_7500000.txt", "dataset_10000000.txt"
    };
    ...
    while (true) {
        ...
        for (int i = 0; i < 11; ++i) {
            string datasetName = datasets1[i];
